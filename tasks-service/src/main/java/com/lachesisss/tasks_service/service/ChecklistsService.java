...
import com.lachesisss.tasks_service.repository.CheckItemsRepository;
import com.lachesisss.tasks_service.repository.ChecklistsRepository;
...
public class ChecklistsService {
	...
	public Optional<List<Checklists>> getChecklistsByIdCard(String idCard) {
		return checklistsRepository.findByIdCard(idCard);
	}
